...
def get_google_sheet():
    ...
    doc = client.open_by_url("https://docs.google.com/spreadsheets/d/1BcoiG1QYMpYEeNKuse1zJvZBoV1fGj5uIlWClaQFRs8/edit?gid=107334424#gid=107334424")
    return doc
    ...
    try:
        ...
        for _, s_row in df_results.iterrows():
            ...
            with PdfPages(pdf_buffer) as pdf:
                ...
                fig.text(0.31, 0.88, '악어수학', fontsize=32, fontweight='bold', color='red', ha='right')
                ...
                fig.text(0.13, 0.44, " 악어수학", fontsize=15, fontweight='bold', color='red')
                ...
                diag_content = (
                    ...
                    f"3. 악어수학 맞춤 솔루션: 단기적으로는 '{worst_unit}' 단원의 오답 노트를 작성하며 취약 유형에 익숙해지는 시간을 가져야 합니다. 중장기적으로 '{worst_cat}' 역량을 끌어올리기 위해 {worst_solution}"
                )
...
# --- 4. Streamlit 웹 UI 구성 ---
st.set_page_config(page_title="악어수학 통합 관리 시스템", layout="wide", page_icon="📊")
col1, col2 = st.columns([8, 2])
with col1: st.title("📊 악어수학 성적 통합 관리 시스템")
with col2: 
